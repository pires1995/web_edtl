...
import hashlib
from .utils import path_and_rename_vacancy_pdf, path_and_rename_vacancy_image, path_and_rename_internships_image, path_and_rename_internships_pdf, path_and_rename_volunteer_image, path_and_rename_volunteer_pdf
...
class Volunteer(models.Model):
    ...
    start_period = models.DateField(null=True, blank=True)
    end_period = models.DateField(null=True, blank=True)
    image = models.ImageField(default='default.jpg', upload_to=path_and_rename_volunteer_image, null=True, blank=True)
    file = models.FileField(upload_to=path_and_rename_vacancy_pdf,
                            validators=[FileExtensionValidator(allowed_extensions=['pdf', 'csv', 'doc', 'docx', 'xls', 'xlsx'])])
    is_active = models.BooleanField(default=False, null=True)
    datetime = models.DateTimeField(auto_now_add=True, null=True)
